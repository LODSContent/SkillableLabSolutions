...
| Item | Detail |
| :--- | :--- |
| **Description** | Jupyter base notebook in a Docker container |
| **Software/Configuration** | Jupyter base notebook installed with default options and a web-based graphical front-end. |
| **Platform/Fabric** | Docker |
| **Hardware** | 2 CPU, 2GB Memory |
...
| :--- | :--- | :--- |
| jupyter/base-notebook | 11/17/2023 | Installed with the latest patches and updates.|
| | |


>[!note] Software patches current as of 11/17/2024
