...
| Item | Detail |
| :--- | :--- |
| **Description** | Visual Studio Code in a Docker container |
| **Software/Configuration** | Visual Studio Code installed with default options and a web-based graphical front-end. |
...
>[!note] Software patches current as of 05/31/2024
